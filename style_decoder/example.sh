...
# For our use-case
python translate.py -model ../models/translation/english_french/english_french.pt -src ../data/ourdata.test.en -output ../data/ourdata.test.fr -replace_unk
python translate.py -encoder_model ../models/translation/french_english/french_english.pt -decoder_model ../models/style_generators/negative_generator.pt -src ../data/ourdata.test.fr -output ../data/ourdata_output.txt -replace_unk